...
Talome ships with **25 built-in widgets** organized into five categories. (Run `ls apps/dashboard/src/components/widgets/*-widget.tsx` if you want the canonical list — the doc below should match.)
...
<Cards>
  ...
  <Card title="AI Assistant Guide" href="/docs/guides/ai-assistant">
    Learn the full scope of what the AI can do — 219 tools across 17 domains.
  </Card>
</Cards>
