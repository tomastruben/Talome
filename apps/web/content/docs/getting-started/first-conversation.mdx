...
![Talome assistant ready for a first conversation](/docs/screenshots/talome-assistant.jpg)
...
Not all 221 registered tools are sent to the AI on every message. Talome uses **per-message tool routing**:
