...
GPT-4o is the recommended model for a good balance of capability and cost. the GPT-4 series (GPT-4o, GPT-4o-mini) is available for heavier reasoning tasks. All Talome tools are compatible.
