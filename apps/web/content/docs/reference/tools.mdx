...
description: Complete reference for all 219 Talome AI tools across 17 domains.
---

Talome's AI assistant has access to 219 tools organized into 17 domains. Each tool has a defined purpose, Zod-validated input parameters, and returns structured data. Tools are classified into three security tiers that determine when and how they can execute.
...
| proxy | 5 | None | Yes |
| tailscale | 3 | None | Yes |
| mdns | 4 | None | Yes |
| ollama | 5 | None | Yes (auto-detects local Ollama) |
| setup | 2 | None | Yes (first-run wizard) |

**Total: 219 registered tools across 17 domains.**
