---
title: MCP Server
description: Use all 220 Talome tools from Claude Code, Cursor, or Claude Desktop.
---

Talome includes a built-in [Model Context Protocol](https://modelcontextprotocol.io) (MCP) server that exposes all 220 tools to external AI clients. Manage your entire home server from Claude Code, Cursor, Claude Desktop, or any MCP-compatible client — without opening the Talome dashboard.
...
This means MCP clients always have the full 220 tool set available.
...
All 220 tools are organized by domain:
...
<Cards>
  <Card title="Tools Reference" href="/docs/reference/tools">
    Complete list of all 220 tools with parameters.
  </Card>
