---
title: App Store
description: Unified app store — four sources, one install pipeline, AI-powered management.
---

Talome's app store unifies four sources into a single browsable, searchable interface. Whether an app was built for Talome, CasaOS, or Umbrel, the install experience is identical — one click or one message.
...
Four sources ship out of the box:

| Source | Description |
|--------|-------------|
| **Talome Native** | Curated apps with deep AI integration, optimized compose files, and healthchecks |
| **CasaOS** | Full CasaOS app store catalog, imported and normalized |
| **Umbrel** | Full Umbrel app store catalog, imported and normalized |
| **My Creations** | Apps you've built with the app creation system |
...
The app store page displays a grid of app cards. Each card shows the app icon, name, tagline, category, and a **source badge** indicating where it came from (Talome, CasaOS, Umbrel, or My Creations).
