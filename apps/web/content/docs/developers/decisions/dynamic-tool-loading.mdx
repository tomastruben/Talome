...
`apps/core/src/ai/tool-registry.ts` — `registerDomain()` at line 65, `getToolsForMessage()` at line 148, `DOMAIN_KEYWORDS` at line 126, settings cache with 10s TTL at line 40. `apps/core/src/ai/agent.ts` — 17 `registerDomain()` calls starting at line 333, `getActiveTools()` called at line 1353.
</Accordion>
</Accordions>
