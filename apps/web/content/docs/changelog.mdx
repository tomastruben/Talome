...
**AI Assistant**
- AI assistant with 221 registered tools across 17 domains (core, media, optimization, arr, qbittorrent, jellyfin, audiobookshelf, overseerr, plex, homeassistant, pihole, vaultwarden, proxy, tailscale, mdns, ollama, setup)
