...
**AI Assistant**
- AI assistant with 220 tools across 17 domains (core, media, optimization, arr, qbittorrent, jellyfin, audiobookshelf, overseerr, plex, homeassistant, pihole, vaultwarden, proxy, tailscale, mdns, ollama, setup)
