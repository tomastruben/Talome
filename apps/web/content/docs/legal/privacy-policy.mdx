...
| **TMDb image CDN** (`image.tmdb.org`) | When the dashboard or media UI shows a poster | Fetches poster art lazily — same source Sonarr/Radarr/Jellyfin use | [TMDb](https://www.themoviedb.org/privacy-policy) |
| **GitHub releases API** | When you click "Check for updates" or run the auto-update job | Compares your version against the latest release | [GitHub](https://docs.github.com/en/site-policy/privacy-policies) |
