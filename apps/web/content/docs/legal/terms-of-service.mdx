...
Talome is a community-driven open-source project. Support is provided on a best-effort basis through [GitHub Issues](https://github.com/tomastruben/Talome/issues) and [Discord](https://discord.gg/HK7gFaVRJ). There is no guaranteed response time or resolution.
...
If you have questions about these terms, open an issue on [GitHub](https://github.com/tomastruben/Talome/issues).
